...
class nnUNetTrainerMRCT_finetunedL1_totalseg(nnUNetTrainer):
    def __init__(
        self,
        plans: dict,
        configuration: str,
        ...
        self.perceptual_loss = UNet_layers("TotalSeg_pelvis_V2")
        self.initial_lr = 1e-3 # divided by 10 for fine tuning

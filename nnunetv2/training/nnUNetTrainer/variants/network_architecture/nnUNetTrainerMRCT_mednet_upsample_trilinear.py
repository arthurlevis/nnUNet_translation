...
import numpy as np
from nnunetv2.training.loss.perceptual import UNet_layers
from nnunetv2.training.loss.mednet import MedicalNet_L1Layers
...
class nnUNetTrainerMRCT_mednet_upsample_trilinear(nnUNetTrainer):
    def __init__(
        self,
        plans: dict,
        configuration: str,
        ...
        self.perceptual_loss = MedicalNet_L1Layers()
